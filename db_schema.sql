-- Makes sure that foreign_key constraints are observed and that errors will be thrown for violations
...
-- Bookings table to store ticket bookings with user info
...
VALUES ('admin@gmail.com', 'admin123', 'Jia en', 'admin', datetime('now'));

-- Insert sample organiser (password: organiser123)
INSERT INTO users (email, password, name, role, created_date) 
VALUES ('organiser@gmail.com', 'organiser123', 'Gerald', 'organiser', datetime('now'));

-- Insert sample user (password: user123)
INSERT INTO users (email, password, name, role, created_date) 
VALUES ('user@gmail.com', 'user123', 'Leroy', 'user', datetime('now'));
